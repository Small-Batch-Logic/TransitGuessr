...
- **Play history** — persistent record of each daily played (theme, score, date); requires Supabase with anonymous auth so history survives across devices; localStorage is insufficient
