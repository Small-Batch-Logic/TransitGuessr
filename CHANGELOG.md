...
- **Station Name Normalizer** — added `normalize_name()` to both GTFS and OSM import scripts; strips platform direction suffixes, mode labels, and redundant "Station" suffixes from imported names; applied retroactively to all 4,793 candidates and 290 curated stations.
